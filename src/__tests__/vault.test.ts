...
// marker_policy=ee*28).
const GOLDEN =
  '';
...
function sampleDatum(): AgentVaultDatum {
  return {
    ...
    markerPolicy: hexToBytes('ee'.repeat(28)),
  };
}
...
describe('AgentVaultDatum codec', () => {
  ...
  it('round-trips through decode', () => {
    ...
    expect(bytesToHex(d.markerPolicy)).toBe('ee'.repeat(28));
  });
